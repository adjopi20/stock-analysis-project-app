...
import { FilterContainerComponent } from '../../../features/stock-info/filter-container/filter-container.component';
import { PaginationComponent } from '../../../features/stock-info/pagination/pagination.component';
...
@Component({
  ...
  standalone: true,
  imports: [HistogramAnalysisComponent, SideNavComponent, FilterComponentComponent, PaginationComponent],
